    ...
    public partial class UpdateUser : Form
    {
        ...
        private void UserUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                FacadeController fc = new FacadeController();
                //UserUpdateController uup = new UserUpdateController();
                fc.updateauser(comboBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, comboBox2.Text, textBox5.Text, DateTime.Parse(dateTimePicker1.Text), textBox6.Text, textBox7.Text, textBox8.Text, textBox9.Text, textBox10.Text, textBox11.Text, int.Parse(textBox12.Text), textBox13.Text, textBox14.Text);
