...
namespace BloodBankOOAD.AcceptorDonorForms
{
    public partial class UserBloodTranfuse : Form
    {
        ...
        private void UserBloodTranfuse_Load(object sender, EventArgs e)
        {
            ...
            int no = utc.ID();
            if (utc.TransfusionData().tt != null)
            {
                UserBloodTransfusee u;
                u = utc.TransfusionData();
        ...
        private void Transfuse_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                utc.UpdatingTransfusion(User.UserID, comboBox1.Text, textBox2.Text, textBox3.Text, DateTime.Parse(dateTimePicker1.Text), int.Parse(textBox4.Text), textBox5.Text, DateTime.Parse(dateTimePicker2.Text));
                //
                textBox1.Clear();
                comboBox1.Text = "";
                textBox2.Clear();
